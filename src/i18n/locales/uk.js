...
- ціну в описі (наприклад '1000грн', або '1000uah', або '₴1000')
- Якщо у вас є інстаграм пости без вказаної ціни, вам потрібно буде відредагувати ціну в онові
- Вам потрібно буде відредагувати категорію товару
...
Ваш пост автоматично продублюється протягом 5хв`,
  ...
  order_status: {
    ...
    not_collected: 'В процесі отримання покупцем',
    not_delivered: 'В дорозі',
    delivered: 'Відправлення прибуло',
