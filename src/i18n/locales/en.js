...
For any questions regarding payments please contact UAPAY at (044) 364-11-44`,
  ...
  add_or_edit_item: {
    ...
    weight_label: 'Weight, gr:',
    min_max_weight: `The weight must be between ${settings.MIN_WEIGHT} and ${settings.MAX_WEIGHT} grams`,
    quantity_label: 'Number of units:',
...
`,
  ...
  chat_rooms: {
    ...
    empty_state_message: 'No conversation/orders found - yet',
  ...
  settings: {
    ...
    instagram_placeholder: 'Instagram username for auto-posting',
